...
function($,t,e,i){function s(t,e){var s=!1,n=t.charAt(0).toUpperCase()+t.slice(1);return $.each((t+" "+r.join(n+" ")+n).split(" "),function(t,n){if(o[n]!==i)return s=!e||n,!1}),s}function n(t){return s(t,!0)}var o=$("<support>").get(0).style,r="Webkit Moz O ms".split(" "),a={transition:{end:{WebkitTransition:"webkitTransitionEnd",MozTransition:"transitionend",OTransition:"oTransitionEnd",transition:"transitionend"}},animation:{end:{WebkitAnimation:"webkitAnimationEnd",MozAnimation:"animationend",OAnimation:"oAnimationEnd",animation:"animationend"}}},h={csstransforms:function(){return!!s("transform")},csstransforms3d:function(){return!!s("perspective")},csstransitions:function(){return!!s("transition")},cssanimations:function(){return!!s("animation")}};h.csstransitions()&&($.support.transition=new String(n("transition")),$.support.transition.end=a.transition.end[$.support.transition]),h.cssanimations()&&($.support.animation=new String(n("animation")),$.support.animation.end=a.animation.end[$.support.animation]),h.csstransforms()&&($.support.transform=new String(n("transform")),$.support.transform3d=h.csstransforms3d())}(window.Zepto||window.jQuery,window,document),function($){"use strict";$(function(){$("#primaryNavigation").mmenu({offCanvas:{zposition:"front",position:"left"}},{clone:!0,transitionDuration:340});var t=$("#mm-primaryNavigation").data("mmenu");t.bind("open:before",function(t){console.log("open"),$(".burger-menu").addClass("active")}),t.bind("close:before",function(t){$(".burger-menu").removeClass("active")})});var t=100,e="30px";$(window).scroll(function(){$(document).scrollTop()>100?($("#primaryNavigation").addClass("fixed"),$("body").css("margin-top","30px")):($("#primaryNavigation").removeClass("fixed"),$("body").css("margin-top","0"))}),$(document).ready(function(){$(".owl-carousel").owlCarousel({items:1,loop:!0,nav:!0,navText:["&#x276E;","&#x276F;"],dots:!0,autoplay:!0})})}(jQuery);